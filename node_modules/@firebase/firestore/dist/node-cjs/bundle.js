...
function loadBundle(data) {
    return database31f1ed21.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    var _this = this;
    return database31f1ed21.namedQuery(this._delegate, queryName).then(function (expQuery) {
        if (!expQuery) {
            return null;
        }
        return new database31f1ed21.Query$1(_this, 
...
registerBundle(database31f1ed21.Firestore);
