...
function loadBundle(data) {
    return database1c628687.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return database1c628687.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new database1c628687.Query$1(this, 
...
registerBundle(database1c628687.Firestore);
