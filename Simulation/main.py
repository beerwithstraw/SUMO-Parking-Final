    ...
    while car_number == 'ABC123' and car_status != 'idle':
        ...
        if db.child("Users").child("username1").child("carstatus").get().val() == 'booked':
            ...
            if parkinglot == 1:
                ...
                traci.vehicle.setRouteID(car_number, 'route_R1')  # Setting route depending on the parking lot assigned
                print(traci.vehicle.getRouteID(car_number))

                traci.vehicle.setParkingAreaStop(car_number, 1, 10)  # Setting a parking area STOP at the parking lot
...
#
#         while car_number == 'DEF123' and car_status != 'idle':
#             traci.simulationStep()
#
#             # User presses button -- state changes from IDLE => BOOKED
...
#
#         while car_number == 'GHI123' and car_status != 'idle':
#             traci.simulationStep()
#
#             # User presses button -- state changes from IDLE => BOOKED
...
#
#         while car_number == 'AAA123' and car_status != 'idle':
#             traci.simulationStep()
#
#             # User presses button -- state changes from IDLE => BOOKED
...
#
#         while car_number == 'BBB123' and car_status != 'idle':
#             traci.simulationStep()
#
#             # User presses button -- state changes from IDLE => BOOKED
